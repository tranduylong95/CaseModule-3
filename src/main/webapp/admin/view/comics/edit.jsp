                ...
                <div class="row">
                    ...
                    <section class="col-lg-12 connectedSortable">
                        ...
                        <div class="card card-info">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal mb-0" method="post" enctype="multipart/form-data" action="/admin/comic/edit/${comic.getId()}">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label ">Tên Truyện Tranh</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="inputEmail3" placeholder="..Tên Truyện Tranh" value="${comic.getName()}" name="name">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="col-sm-10 p-0" style="margin-bottom: 10px" >
                                                <img src="${comic.getImage()}" style="max-width: 250px;min-height: 375px;" id="blah">
                                                <input type="text" name="imageText" value="${comic.getImage()}" hidden>
                                            </div>
                                            <input type="file"  accept="image/*" placeholder="Password" name="image" id="imgInp">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="clearfix col-10 ">
                                            <div class="icheck-primary d-inline">
                                                <input type="checkbox" id="checkboxPrimary1" <c:if test="${comic.getHot()==1}">checked</c:if> name="hot" value="1">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-10">
                                            <div class="icheck-primary d-inline" >
                                                <input type="radio" id="radioPrimary1" name="sex" <c:if test="${comic.getSex()==1}">checked</c:if> value="1">
                                                <label for="radioPrimary1">
                                                    Nam
                                                </label>
                                            </div>
                                            <div class="icheck-primary d-inline" style="margin-left: 5px">
                                                <input type="radio" id="radioPrimary2" name="sex" <c:if test="${comic.getSex()==2}">checked</c:if> value="2">
                                                <label for="radioPrimary2">
                                                    Nữ
                                                </label>
                                            </div >
                                            <div class="icheck-primary d-inline" style="margin-left: 5px">
                                                <input type="radio" id="radioPrimary3" name="sex" <c:if test="${comic.getSex()==0}">checked</c:if> value="0">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="duallistbox" multiple="multiple" name="categories" >
                                                <c:forEach items="${listCategory}" var="category">
                                                    <c:forEach items="${comic.getCategoryList()}" var="categories">
                                                    </c:forEach>
                                                    <option value="${category.id}" <c:forEach items="${comic.getCategoryList()}" var="categories">
                                                        <c:if test="${categories.getId()==category.id}">
                                                            selected
                                                        </c:if>
                                                    </c:forEach>>${category.name}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-10">
                                            <div class="icheck-primary d-inline" >
                                                <input type="radio" id="radioPrimary5" name="status" <c:if test="${comic.getStatus()==0}">checked</c:if> value="0">
                                                <label for="radioPrimary5" >
                                                    Đang tiến hành
                                                </label>
                                            </div>
                                            <div class="icheck-primary d-inline" style="margin-left: 5px">
                                                <input type="radio" id="radioPrimary6" name="status" <c:if test="${comic.getStatus()==1}">checked</c:if> value="1">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-10">
                                            <div class="icheck-primary d-inline" >
                                                <input type="radio" id="radioPrimary7" name="show"  <c:if test="${comic.getShow()==1}">checked</c:if> value="1">
                                                <label for="radioPrimary7">
                                                    Hiển thị
                                                </label>
                                            </div>
                                            <div class="icheck-primary d-inline" style="margin-left: 5px">
                                                <input type="radio" id="radioPrimary8" name="show"  <c:if test="${comic.getShow()==0}">checked</c:if> value="0">
