                            ...
                            <section class="col-lg-12 connectedSortable">
                                ...
                                <div class="card card-info">
                                    <div class="card-header">
                                        <h3 class="card-title">Thêm mới Page</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form class="form-horizontal mb-0" action="/admin/comic/chapter${pathInfo}" method="post" >
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label  class="col-sm-2 col-form-label ">Tên page</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control"  placeholder="..Tên Truyện Tranh" name="name">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label  class="col-sm-2 col-form-label ">Đường dẫn</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" placeholder="....Đường dẫn" name="link">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label  class="col-sm-2 col-form-label ">Chỉ số</label>
                                                <div class="col-sm-10">
                                                    <input type="number" class="form-control" placeholder="....Đường dẫn" name="index" max="100" min="0">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
